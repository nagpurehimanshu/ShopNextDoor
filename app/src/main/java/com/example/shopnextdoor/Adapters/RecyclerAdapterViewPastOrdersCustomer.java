...
public class RecyclerAdapterViewPastOrdersCustomer extends RecyclerView.Adapter<RecyclerAdapterViewPastOrdersCustomer.MyViewHolder>{

    private List<Orders> ordersList;
    public RecyclerAdapterViewPastOrdersCustomer(List<Orders> inputData){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.customer_view_past_orders_row, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if(ordersList.get(position).getOrder_status().equals("rejected")){
            ...
            holder.accepted_on.setText(ordersList.get(position).getOrder_acceptance_date());
            holder.completed_on.setText(ordersList.get(position).getOrder_completion_date());
            holder.order_status_info.setText("Your order completed successfully.");
