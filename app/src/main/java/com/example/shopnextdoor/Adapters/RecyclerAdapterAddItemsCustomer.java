...
public class RecyclerAdapterAddItemsCustomer extends RecyclerView.Adapter<RecyclerAdapterAddItemsCustomer.MyViewHolder> {

    //inputData stores the all the entries in the form of lists of Data
    private List<Data> inputData;

    public RecyclerAdapterAddItemsCustomer(List<Data> inputData){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.customer_shopping_items, parent, false);
